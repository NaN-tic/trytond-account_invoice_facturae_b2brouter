...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_invoice_facturae_b2brouter',
    download_url='https://github.com:nantic/trytond-account_invoice_facturae_b2brouter.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_invoice_facturae_b2brouter.git'
    },
    classifiers=[
